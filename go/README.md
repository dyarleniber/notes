...
But, you can also write multiple import statements.
...
> To learn more about slices, read the Slices: [usage and internals article](https://blog.golang.org/go-slices-usage-and-internals).
